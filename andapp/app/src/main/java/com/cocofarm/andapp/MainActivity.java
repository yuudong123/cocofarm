...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // params.topMargin = mContext.getResources().getDimensionPixelSize(mContext.getResources().getIdentifier("status_bar_height", "dimen", "android"));
    ...
    protected void onStart() {
        ...
        ((TextView)binding.navView.getHeaderView(0).findViewById(R.id.tv_right_nav_email)).setText(loginMember.getEmail());
        ((TextView)binding.navView.getHeaderView(0).findViewById(R.id.tv_right_nav_nickname)).setText(loginMember.getNickname());
    }
